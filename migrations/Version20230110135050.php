 ...
 */
final class Version20230110135050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE optreden (id INT AUTO_INCREMENT NOT NULL, poppodium_id INT NOT NULL, artiest_id INT NOT NULL, voorprogramma_id INT NOT NULL, omschrijving VARCHAR(50) NOT NULL, datum VARCHAR(50) DEFAULT NULL, prijs INT NOT NULL, ticket_url VARCHAR(100) DEFAULT NULL, afbeelding_url VARCHAR(100) DEFAULT NULL, INDEX IDX_6286F65DA2EEBB18 (poppodium_id), INDEX IDX_6286F65DAED85528 (artiest_id), INDEX IDX_6286F65DE017CE10 (voorprogramma_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
